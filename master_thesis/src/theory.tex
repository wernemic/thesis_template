...
However, gamma radiation is of composed of high-energy photons. 
...
\footnotetext{\url{https://openclipart.org/detail/274074/penetrating-power-of-different-types-of-radiation-alpha-beta-gamma-and-neutrons} Accessed: \today }
...
\section{Some properties of ionizing radiatiou}
...
This rapid decrease makes the search for sources of ionizing radiation challenging since it limits the sensing range of the sensors.
  ...
  \begin{figure}[!h]
    ...
    \caption{An illustration of the inverse square law for the intensity of radiation. Source\protect\footnotemark }%Source: \cite{inverse_square_law}}
      \label{fig:islaw}
  \end{figure}
\footnotetext{\url{https://commons.wikimedia.org/wiki/File:Inverse_square_law.svg} Accessed: \today }
% %%}
...
The pair production occurs only if the $\gamma$ photon has energy exceeding $\approx \SI{1}{\mega\electronvolt}$.
...
\begin{figure}[!h]
  ...
  \includegraphics[width=0.7\textwidth]{./fig/photos/my_minipix.eps}
    \caption{Illustration of the detection process inside the \ac{pix} sensor. 
    ...
    The free electrons (produced by the Compton scattering and scattered photon's absorption) are detected by the Timepix3 pixel detector. 2D positions and energies ($E_{1}, E_{2}$) are recorded. 
...
\begin{figure}[!h]% %%{
  ...
  \caption{The \ac{pix} sensor and its real size \protect\subref{fig:minipix_pen} and the illustration of output from Timepix3 pixel detector \protect\subref{fig:timepix_image}.} 

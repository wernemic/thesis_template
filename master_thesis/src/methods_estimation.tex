...
\begin{figure}[!h]
  ...
  \subfloat[Polar coordinates] {
    \includegraphics[width=0.3\textwidth]{./fig/photos/axes.eps}
    \label{fig:polar}
  }
  \subfloat[Locations of simulated sources] {
    \includegraphics[width=0.3\textwidth]{./fig/photos/mc_sources.eps}
    \label{fig:sources_loc}
  }
  \subfloat[Sampling of the sphere] {
    \includegraphics[width=0.3\textwidth]{./fig/photos/mc_angle_space.eps}
    \label{fig:sampling}
  }
  \caption{}
  \label{fig:mc_multi}

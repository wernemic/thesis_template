...
\chapter{Compton imaging for a group of UAVs}
This chapter describes the proposed method for data fusion of Compton measurement acquired by a group of \ac{UAV}s.
The challenges related to the task and motivation for the proposed solution is described in section \ref{sec:prelim}.
Section \ref{sec:setup} presents the adaptation of \ac{MLEM} to the given task.
The estimation of sensitivity as well as system matrix is then desribed in section \ref{sec:sensitivity} and \ref{sec:system}.
...
\subsection{The algorithm of choice}
...
\section{MLEM for robotics application}
\label{sec:setup}
\subsection{Setup}

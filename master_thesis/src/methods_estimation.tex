...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%}
\newpage
\subsection{sensitivity of detection for robotic radiation mapping}% %%{
...
\subsection{System matrix for robotic radiation mapping}
...
states that the energy resolution of used TIimepix3 pixel detector is $4.5--9.9\ \mathrm{kEV}$. 

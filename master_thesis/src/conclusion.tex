...
Further investigation of parameters influencing the quality and speed of reconstruction (noise, size of the area, number of sources and their activity) also presents a task for future.
